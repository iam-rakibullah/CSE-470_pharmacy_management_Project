<?php
  ...
  if(isset($_GET["action"]) && $_GET["action"] == "delete") {
    ...
    $query = "DELETE FROM invoices WHERE CUSTOMER_ID = $invoice_number";
  ...
  function showInvoiceRow($seq_no, $row) {
    ...
    <tr>
      ...
      <td>
        <button class="btn btn-warning btn-sm" onclick="printInvoice(<?php echo $row['CUSTOMER_ID']; ?>);">
          <i class="fa fa-fax"></i>
        </button>
        <button class="btn btn-danger btn-sm" onclick="deleteInvoice(<?php echo $row['CUSTOMER_ID']; ?>);">
